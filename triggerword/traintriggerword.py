...
mc = ModelCheckpoint('best_trigger_model_TM_30lr0.01.h5', monitor='acc', mode='max', verbose=1, save_best_only=True)

print('Splitting and training')
# X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=0.2, random_state=42, shuffle=True)
history = model.fit(X_train, Y_train, callbacks=[es, mc], batch_size=32, epochs=30)
